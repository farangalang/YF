...
namespace MyYouthFutures.Controllers
{
    public class TitlesController : Controller
    {
        ...
        public TitlesController(YouthContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,BackgroundImage,Header,SubHeader,Footer")] Title title)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,BackgroundImage,Header,SubHeader,Footer")] Title title)
        {
            if (id != title.ID)
            {
                return NotFound();
