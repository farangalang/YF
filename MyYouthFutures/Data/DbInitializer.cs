    ...
    public class DbInitializer
    {
        ...
        public async Task Seed()
        {
            ...
            var services_messages = new Services_Message[]
            {
                ...
                new Services_Message{TargetControler="home",TargetAction="about",TargetFragment="StreetOutreach",MessageImage="/images/van_icon.png", MessageHeader="Street Outreach", Message="Youth Futures’ Street Outreach is conducted once per week and provides outreach and crisis services to youth in Ogden City, Utah."}
            };
