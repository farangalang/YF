...
namespace MyYouthFutures.Data
{
    public class DbInitializer
    {
        ...
        public async Task Seed()
        {
            ...
            {
                new List_Item{TypeOfList="outReach",GroupID = 1,LiText="Jefferson Park"},
                new List_Item{TypeOfList="outReach",GroupID = 1,LiText="Marchall White Center Park"},
                new List_Item{TypeOfList="outReach1",GroupID = 2,LiText="Lorin Farr Skate Park"},
                new List_Item{TypeOfList="outReach1",GroupID = 2,LiText="Under the Ogden River Bridge (sporadic)"},
                new List_Item{TypeOfList="outReach1",GroupID = 2,LiText="Lantern House Homeless Shelter"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Cash donations"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Printer Paper"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Canned meat & Jerky"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Scotch tape"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Bus tokens or passes"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Basketball Court at Bonneville Park"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Earbud Headphones"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Cinch bags"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Batteries"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Sweat Pants"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Pajama Bottoms"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Sports bras"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Trail mix individuals"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Toilet Paper"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Condoms"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Tampons"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Carabiners"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Paper plates and cups"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Men's and Women's Underwear"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Socks"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Kleenex individuals"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Undershirts, S M L XL"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Garbage bags 30 Gallon"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Garbage sacks small    bathroom"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Lip balm"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Ziploc bags, quart and gallon"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Energy Bars"},
                new List_Item{TypeOfList="mostImportantNeeds",GroupID = 3,LiText="Heavy duty plastic storage bins that won't melt if heated in shed"},
                new List_Item{TypeOfList="MISCNEEDS",GroupID = 4,LiText="Minivan"},
                new List_Item{TypeOfList="MISCNEEDS",GroupID = 4,LiText="NEW Printer"},
                new List_Item{TypeOfList="GiftCardsForNeeds",GroupID = 5,LiText="Walmart"},
                new List_Item{TypeOfList="GiftCardsForNeeds",GroupID = 5,LiText="Fun things to do"},
                new List_Item{TypeOfList="GiftCardsForNeeds",GroupID = 5,LiText="Grocery store"},
                new List_Item{TypeOfList="GiftCardsForNeeds",GroupID = 5,LiText="Maverick"},
                new List_Item{TypeOfList="GiftCardsForNeeds",GroupID = 5,LiText="Restaurants"},
                new List_Item{TypeOfList="GiftCardsForNeeds",GroupID = 5,LiText="Movies"},
                new List_Item{TypeOfList="GiftCardsForNeeds",GroupID = 5,LiText="Bus passes or tokens"},
                new List_Item{TypeOfList="GiftCardsForNeeds",GroupID = 5,LiText="Phone minutes"},
                new List_Item{TypeOfList="GiftCardsForNeeds",GroupID = 5,LiText="Beauty salons/haircuts"},
                new List_Item{TypeOfList="GiftCardsForNeeds",GroupID = 5,LiText="For shoe stores"},
                new List_Item{TypeOfList="GiftCardsForNeeds",GroupID = 5,LiText="Lagoon passes"},
                new List_Item{TypeOfList="HouseholdFurnishingsNeeds",GroupID = 6,LiText="NEW pots and pans"},
                new List_Item{TypeOfList="HouseholdFurnishingsNeeds",GroupID = 6,LiText="New Couches"},
                new List_Item{TypeOfList="Volunteers",GroupID = 7,LiText="Mentors"},
                new List_Item{TypeOfList="Volunteers",GroupID = 7,LiText="Educators"},
                new List_Item{TypeOfList="Volunteers",GroupID = 7,LiText="Group activity facilitators"},
                new List_Item{TypeOfList="Volunteers",GroupID = 7,LiText="Meal preparers/providers"},
                new List_Item{TypeOfList="Volunteers",GroupID = 7,LiText="Tutors"},
                new List_Item{TypeOfList="Volunteers",GroupID = 7,LiText="Life skills trainers"},
                new List_Item{TypeOfList="Volunteers",GroupID = 7,LiText="Beauticians"},
                new List_Item{TypeOfList="Volunteers",GroupID = 7,LiText="Street Outreach Workers"},
                new List_Item{TypeOfList="Volunteers",GroupID = 7,LiText="Artists for classes"},
                new List_Item{TypeOfList="Volunteers",GroupID = 7,LiText="Yard work"},
                new List_Item{TypeOfList="Volunteers",GroupID = 7,LiText="Interior painters"},
                new List_Item{TypeOfList="RepairNeeds",GroupID = 8,LiText="Concrete or pavers 1500 sq. feet"},
                new List_Item{TypeOfList="RepairNeeds",GroupID = 8,LiText="Cement sidewalk repair& labor"}
            };
            ...
            var Media_Message = new Media[]
            {
                ...
                new Media{Title="America First Provides an 'Assist' to Homeless Shelter",Time="03/18/2015 10:03 pm",Image="/images/media_check.jpg",SubTitle="At right, from left to right: Kristen Mitchell, executive director of Youth Futures Utah and Scott Tuccio, president of the Board of Directorsof Youth Futures Utah, stand with Nicole Cypers, public relations and social media manager for America First Credit Union, at the Weber State basketball game for a check presentation in the amount of $3,400 on Saturday, March 7 at Weber State University.",Content_Text="OGDEN, Utah--America First Credit Union awarded Youth Futures Utah, a homeless shelter for youth, with $3,400 during the Weber State University basketball game. America First paid the organization $10 for each assist the Weber State University basketball team completed throughout the 2014 – 2015 season. With 340 assists, the donation amounted to $3,400 in total for the newly-opened youth homeless organization, located in Ogden, Utah.\nYouth Futures Utah is a 501(c)3 organization committed to the well-being of the youth of Utah. The mission of Youth Futures Utah is to provide shelter, support, resources and guidance to homeless, unaccompanied and runaway youth in Utah. Youth Futures connects each youth with food, housing and resources to build the skills needed to support a healthy future."}
            };
